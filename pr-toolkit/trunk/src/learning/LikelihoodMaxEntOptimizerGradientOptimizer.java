...
//	
//	public LikelihoodMaxEntOptimizerGradientOptimizer(MultinomialFeatureFunction featFunct,
...
//		AbstractModel model;
//		
//		MaxEntMinimizationObjective(AbstractModel model,
//				double[] initialParameters,  
//				int variable,
//				double gaussianPriorVariance) {
//			this.model =model;
//			this.counts = model.getCountTable();
