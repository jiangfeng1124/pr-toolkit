 ...
 *
 */
public class DirectGradientTransitionsTypeL1LMaxStats extends MultinomialMaxEntDirectTrainerStats{
		...
		PosCorpus c;
		String[] allTags;
        public DirectGradientTransitionsTypeL1LMaxStats(PosCorpus c, HMM model, String printEvery, String outputDir, int printClustersIter) {
        	this.c = c;
